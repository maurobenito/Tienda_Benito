...
builder.Services.AddTransient<IRepositorio<Rubro>, RepositorioRubro>();
...
builder.Services.AddTransient<IRepositorio<Ventadetalle>, RepositorioVentadetalle>(); // ✅ ESTA LÍNEA
