...
public IActionResult Edit(int id)
{
    ...
    return View(usuario);
        ...
        [HttpPost]
[ValidateAntiForgeryToken]
public IActionResult Edit(int id, Usuario usuario, IFormFile? AvatarFile, string? Password)
{
    ...
    if (ModelState.IsValid)
    {
        ...
        {
            // Actualizar password solo si el usuario puso uno nuevo
            existente.PasswordHash = Password; // Debería ser hash
        }
