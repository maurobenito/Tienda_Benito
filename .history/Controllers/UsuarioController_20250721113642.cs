...
public IActionResult Create(Usuario usuario, IFormFile? FotoPerfilFile, string Password)
{
    if (ModelState.IsValid)
    {
        // Procesar foto de perfil si se cargó
        ...
        // Hashear la contraseña si se recibió
